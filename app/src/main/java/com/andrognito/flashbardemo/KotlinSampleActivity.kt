...
import com.andrognito.flashbar.R.color.white
import com.andrognito.flashbar.anim.FlashAnim
import com.andrognito.flashbardemo.databinding.ActivityMainBinding
...
class KotlinSampleActivity : AppCompatActivity() {
    ...
    private fun titleAdvanced(): Flashbar {
        return Flashbar.Builder(this)
                ...
                .titleTypeface(createFromAsset(assets, "BeautifulAndOpenHearted.ttf"))
                .build()
    }
    ...
    private fun messageAdvanced(): Flashbar {
        return Flashbar.Builder(this)
                ...
                .messageColor(getColor(this, white))
                .messageSizeInSp(16f)
                .messageTypeface(createFromAsset(assets, "BeautifulAndOpenHearted.ttf"))
                .build()
    }
    ...
    private fun barTap(): Flashbar {
        return Flashbar.Builder(this)
            .gravity(TOP)
            .title("Hello World!")
            .message("You can listen to tap events inside or outside the bar.")
